...
export function registerTools(
  ...
  context.subscriptions.push(
    vscode.lm.registerTool('myDevTeam_readFile', {
  ...
  context.subscriptions.push(
    vscode.lm.registerTool('myDevTeam_searchFiles', {
      async invoke(options) {
  ...
  context.subscriptions.push(
    vscode.lm.registerTool('myDevTeam_runCommand', {
      async invoke(options) {
  ...
  context.subscriptions.push(
    vscode.lm.registerTool('myDevTeam_writeFile', {
      async invoke(options) {
